...
namespace Columbia583
{
	...
	public class Data_Layer_Tests
	{
		...
		public string insertIntoTables()
		{
			...
			points [0] = new Point (1, 1, 1, 2, "", "", 100, 101, true, DateTime.Now, DateTime.Now, false);
			points [1] = new Point (2, 1, 1, -1, "", "", 110, 111, false, DateTime.Now, DateTime.Now, false);
			points [2] = new Point (3, 1, 1, 4, "", "", 120, 121, true, DateTime.Now, DateTime.Now, false);
			points [3] = new Point (4, 1, 1, -1, "", "", 130, 131, false, DateTime.Now, DateTime.Now, false);
			points [4] = new Point (5, 1, 1, 6, "", "", 140, 141, true, DateTime.Now, DateTime.Now, false);
			points [5] = new Point (6, 1, 1, -1, "", "", 150, 151, false, DateTime.Now, DateTime.Now, false);
