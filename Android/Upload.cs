...
namespace Columbia583.Android
{
	...
	public class Upload : AndroidActivity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			SetContentView (Resource.Layout.UploadTrail2);
			...
			upload.Click += (object sender, EventArgs e) => {
				...
				Trail trail = new Trail(1009, 1,1,name,location,"","",distance,duration,discription,directions, getDifficulty, getRating,hazards,surface,landAccess,maintenance,season, getOpen, getActive,DateTime.Now,DateTime.Now,true);
				data_access_layer.insertTrail(trail);
				//Console.Out.WriteLine(myView.getRating);
				//Console.Out.WriteLine(myView.getDifficulty);

				Trail list_trail = data_access_layer.getTrailID(1009);
